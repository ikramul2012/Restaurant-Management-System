...
<nav class="custom-navbar navbar navbar-expand-lg navbar-dark fixed-top" data-spy="affix" data-offset-top="10">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <a class="navbar-brand m-auto" href="{{url('/')}}">
            ...
            <span class="brand-txt">The Regal Elephant</span>
        </a>
        <ul class="navbar-nav">
            <li class="nav-item"><a class="nav-link" href="#blog"><span class="sr-only">(current)</span></a></li>
...
<div id="gallary" class="text-center bg-dark text-light has-height-md middle-items wow fadeIn">
    ...
    <table>
        ...
        <tr>
            <td>{{$data->title}}</td>
            <!-- Show the actual price of a single item, not multiplied by quantity -->
        ...
        <?php
        // Total price remains the same (price * quantity)
